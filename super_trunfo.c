...
int main(){
    ...
    printf(" ** Qual é a carta vencedora na comparação das populações? ** \n");
    printf("Valor do atributo População na Carta 1: %lu\n", populacao1);
    printf("Valor do atributo População na Carta 2: %lu\n", populacao2);
